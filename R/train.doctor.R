train.doctor <-
function(F_,L_,training.samples, validating.samples, considered.features, maximum.features.num, 
...
#****	liner modeling: MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
	...
	#probability <- c()							# For the validating samples, we consider the logistic score as the probability of being in class +1. 
